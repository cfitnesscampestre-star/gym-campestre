...
| Entrenadores o su filosofía no sincronizan entre dispositivos | Las reglas de Firebase no incluyen el permiso para "entrenadores" — vuelve a pegar **firebase-rules.json** actualizado en Reglas y publica |
