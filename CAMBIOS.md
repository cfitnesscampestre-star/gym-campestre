...
- Foto pequeña (miniatura), sin marco ni fondo propio — se ve el fondo del modal detrás, en vez de una tarjeta sólida. El tip del entrenador (el del foquito 💡) va sobrepuesto como etiqueta discreta en la esquina inferior de la foto, en vez de un bloque de color aparte arriba.
